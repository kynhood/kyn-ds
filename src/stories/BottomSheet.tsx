    ...
    <div className="bottom-sheet" data-testid="bottom-sheet">
      <div className="bottom-sheet-container">
        <div className="bottom-sheet-content-area">
          ...
          <div className="bottom-sheet-text-section">
                ...
                >
                  <g id="vector">
                    <path
                      ...
                      fill="var(--color-neutral-color-dark-dark-500)"
                    />
                    <path
                      clipRule="evenodd"
          ...
          <button className="bottom-sheet-button" onClick={onButtonClick} data-testid="action-button">
            <div className="bottom-sheet-button-content">
              <div className="bottom-sheet-button-icon">
                <svg
                  width="22"
                  height="22"
                  viewBox="0 0 22 22"
              ...
              <p className="bottom-sheet-button-label">{buttonLabel}</p>
            </div>
          </button>
        </div>
      </div>
